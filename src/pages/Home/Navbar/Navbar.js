    ...
    return (
        <div className={styles.Navbar}>
            ...
            <ul className={`${styles.Navbar__nav} ${isOpen && styles.Navbar__nav__open}`}>
                <li className={styles.Navbar__navItem}><Link>Home</Link></li>
                <li className={styles.Navbar__navItem}><Link>About</Link></li>
                <li className={styles.Navbar__navItem}><Link>Dashboard</Link></li>
